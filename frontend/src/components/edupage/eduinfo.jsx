import "./eduinfo.css";
import mainImage from "../../assets/vanshImage(1).png";
          ...
          <div className="float-container">
            <div className="float-img">
              <div className="img-background">
                <img src={mainImage} alt="" id="float-img" draggable={false} />
              </div>
            </div>
            <div className="float-skills">
              <div className="float-skills-heading">
                <p>Skills</p>
              </div>
              {Skills.map((item, index) => {
                return (
                  <div className="float-skills-data">
                    <div className="float-skills-left">
                      {/* <img src={nexticon} alt="" draggable={false} /> */}
                      <p>{item.name}</p>
                    </div>
                    <div className="float-skills-right">
